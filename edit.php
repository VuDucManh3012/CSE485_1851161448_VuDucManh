...
<body>
    ...
    <div class="container-fruid col-sm-12">
        ...
        <div class="row">
            ...
            <div class="row col-sm-6"> 
                <form class="col-xs-12 col-sm-6 col-md-10" name="myForm" action="process-edit.php" method="POST" onsubmit="return validateFormEdit()" required>
                    <div class="form-group">
                        <label for="txtPassword">Mật khẩu cũ:</label>
                        <input type="password" class="form-control" name="txtPassword" id="txtPassword">
                    </div>
                    <div class="form-group">
                        <label for="txtPassword1">Mật khẩu mới:</label>
                        <input type="password" class="form-control" name="txtPassword1" id="txtPassword1">
                    </div>
                    <div class="form-group">
                        <label for="txtPassword2">Nhập lại mật khẩu mới:</label>
    ...
    <script>
        function validateFormEdit() {
            ...
            var y = document.forms["myForm"]["txtPassword1"].value;
            if (y == "" || y == null) {
                alert("Bạn cần nhập mật khẩu mới");
                return false;
            }
            var z = document.forms["myForm"]["txtPassword2"].value;
            if (z == "" || z == null) {
                alert("Bạn cần xác nhận mật khẩu mới");
                return false;
            }
            if (y !== z) {
