    ...
    <div class="container-fruid col-sm-12">
        ...
        <div class="row">
            ...
            <div class="row col-sm-6">
                <form class="col-xs-12 col-sm-6 col-md-10" name="myForm" action="process-editanh.php" method="POST">
                    <div class="form-group">
                        <br>
                        <label for="newanhdaidien">Chọn ảnh đại diện mới:</label><br>

                        <input type="file" id="newanhdaidien" name="newanhdaidien"><br>
                    </div>
