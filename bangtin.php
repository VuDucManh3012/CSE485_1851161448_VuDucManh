...
<body>
    <div class="container">
        ...
        $result = mysqli_query($conn, "SELECT * FROM post2 ORDER BY `id` DESC");
        ...
        while ($row = mysqli_fetch_array($result)) {
                ...
                if (!isset($_SESSION['username'])) {
                    ...
                    echo "<form class='col-md-12 d-flex' action='comment.php' method='POST'>";
                    ...
                    }echo"<input class='form-control' name='idpost' style='display:none' value=' ".$row['id']." '>";
                    echo"<input class='form-control' name='noidung' style='margin-left:7px;' placeholder='Viết bình luận...' >
                    <input name='submit' id='submit' class='btn btn-primary btn-block' type='submit' value='OK'>
                </form>";
                    echo "<br>";
                } 
                echo "<div>";
                $idpost=$row['id'];
                $result3 = mysqli_query($conn, "SELECT * FROM `comment` where `idpost`= '$idpost' ");
