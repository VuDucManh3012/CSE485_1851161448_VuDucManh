...
<body>
    ...
    <div class="container-fruid col-sm-12">
        ...
        <div class="row">
            ...
            <div class="main col-sm-6">
                <br>
                <button type="button" class="form-control" name="txpost" id="txpost" onclick="doimatkhau()" style="text-align:center;"><h6>Đổi mật khẩu</h6></button><br>
                <button type="button" class="form-control" name="txpost" id="txpost" onclick="doiten()" style="text-align:center;"><h6>Đổi tên</h6></button><br>
                <button type="button" class="form-control" name="txpost" id="txpost" onclick="doianh()" style="text-align:center;"><h6>Đổi ảnh đại diện</h6></button><br>
            </div>
    ...
    <script>
        ...
        function doiten(){
            window.location.href = 'editten.php';
        }
        function doianh(){
            window.location.href = 'editanh.php';
        }
        function openForm() {
            document.getElementById("myFormdoimatkhau").style.display = "block";
        }
