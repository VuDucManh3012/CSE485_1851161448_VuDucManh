				...
				<div class="globalnav">
					<div class="container">
						<div class="header_top">
							<div class="lable">
								<a href="trangchu.php" class="ui-link-white"> Trường Đại học Thủy Lợi - TLU</a>
							</div>
							<!-- class lable -->
							<ul class="list-top">
								<li>(+) | </li>
								<!-- login -->
								<li>
									<a href="login.php" data-action="">Login</a>
								</li>
								...
								<li class="language">
									...
									<a title="Tiếng Việt" class="ui-link-white lang-vi">
							...
							<div class="container-search">
								<div class="dnn_Search">
									<div class="viewsearch">
										...
										<input type="image" class="searchbutton" value="tim" src="img/search-icon.png" width="40px;">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="logokhoa.php">Logo khoa CNTT</a>
